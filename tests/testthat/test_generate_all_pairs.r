...
test_that("censoring works correctly", {
  ...
  data <- data.table(.id=c(1, 2, 3, 4), .time=c(20, 45, 80, 20),
                     .min_t=0, .max_t=c(100, 60, 200, 200))
...
test_that("works with multiple exposures in one person", {
  ...
  # no pairs possible
  data <- data.table(.id=c(1, 4, 4), .time=c(20, 80, 20), .min_t=0, .max_t=1000)
...
test_that("multiple exposures per person, some censored", {
  ...
  data <- data.table(.id=c(1, 1, 4, 4, 4), .time=c(20, 45, 110, 20, 70),
                     .min_t=0, .max_t=c(1000, 1000, 120, 120, 120))
...
test_that("invalid matches due to later follow-up start are ignored", {

  data <- data.table(.id=c(1, 2, 3, 4), .time=c(20, 45, 80, 20),
                     .min_t=c(0, 0, 40, 0), .max_t=1000)

  expected <- data.table(.id=c(2, 3, 4),
                         .time=c(45, 80, 20),
                         .min_t=c(0, 40, 0),
                         .max_t=c(1000, 1000, 1000),
                         .id2=c(1, 2, 2),
...
test_that("both .min_t and .max_t are used", {

  data <- data.table(.id=c(1, 2, 3, 4), .time=c(20, 45, 80, 20),
                     .min_t=c(0, 0, 40, 0), .max_t=c(1000, 1000, 1000, 45))

  expected <- data.table(.id=c(2, 3),
                         .time=c(45, 80),
                         .min_t=c(0, 40),
                         .max_t=c(1000, 1000),
                         .id2=c(1, 2),
